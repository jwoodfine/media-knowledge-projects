...
## The Same Geometry Also Decides How Much Building There Is

The regulatory instruments above are one consequence of a broader discipline: sizing each Woodfine Building from real furniture, circulation, and daylight requirements rather than an area-per-person formula. The same proof that fixes operating cost also fixes construction volume — a building sized to its accommodation, with no allowance added for planning uncertainty, has no area to construct, condition, or maintain beyond what tenants actually occupy. Woodfine treats this as one discipline with two consequences, not two separate initiatives: cheaper to run, and smaller to build in the first place. The construction-volume side of this discipline, together with its companion approach to site landscaping and material selection, is developed at [bim.woodfinegroup.com](https://bim.woodfinegroup.com); this article treats the operating-cost consequence only.

## See also

- [[key-plans-and-tiles|Key Plans and Tiles]] — the furniture- and circulation-derived geometry that this article's regulatory standards are engineered into
- [[dual-mandate-building-certifications|Dual-Mandate Building Certifications]] — how this outcome-first approach relates to third-party ESG certification
- [[four-to-one-parking-ratio|Four-to-One Parking Ratio]] — the landscape side of the same broader sustainability discipline
- [[water-management-system|Water Management System]] — another structural, geometry-fixed sustainability outcome in the Woodfine prototype
