...
Building Design covers the design system behind every Woodfine building: fixed floor plates and measurement standards, an open-standards BIM practice, and the site-and-building standards that turn those elements into a buildable, sustainable property.
